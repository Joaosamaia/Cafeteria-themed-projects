...
def comunicar_empresa_terceirizada():
    ...
    # -> Codigo ou forma de comunicação com a empresa terceirizada (depende da empresa que for, e do contrato que tiverem, por isso não vi sentido em fazer.) <-
